 ...
 *
 * Task authoring happens **before** the loop, via the `/agent-loop new`
 ...
 * `/agent-loop approve <id>` is the human plan gate; the next claim
 ...
 * sends the task back to the PLAN stage via `/agent-loop reject <id>`.
 */
 ...
 *  in-progress task whose plan was approved via `/agent-loop approve`. */
