 ...
 */
export declare const worstOf: (verdicts: readonly (Verdict | null)[]) => Verdict;
/** Render the failed criteria as a prompt block for the next iteration, or "". Pure. */
export declare const failedCriteriaBlock: (record: VerdictRecord | null) => string;
/** The verdict tags emitted by the loop's check stages. */
export declare const LOOP_VERIFY_TAG = "LOOP_VERIFY";
export declare const LOOP_REVIEW_TAG = "LOOP_REVIEW";
export declare const parseVerdict: (text: string, tag: string) => Verdict | null;
