...
export declare const pollOnce: (sources: readonly WorkSource[]) => Promise<PollResult>;
/** Merge skip reasons into one displayable reason; null when there were none. */
export declare const combineSkips: (skips: readonly ClaimSkipReason[]) => ClaimSkipReason | null;
