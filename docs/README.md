...
| [recurring.md](recurring.md) | The `recurring` kind — standing work orders that repeat their whole lifecycle on their own schedule (definition format, scheduling semantics, guard rails). Not a sitter: it watches no external surface |
