...
| Mocking everything | Tests pass, production breaks | Real > fake > stub > mock; mock only slow/non-deterministic boundaries |

## State-Based vs Interaction-Based, and DAMP
